...
char *elenco_riparazioni[15] = {"GOMMISTA\0","MECCANICO\0", "ELETTRAUTO\0", "CARROZZIERE\0", "POMPISTA\0","TAPPEZZIERE\0","VETRAIO\0"};
int NR = 7;
...
struct officina_t {
    ...
    int riparazione,in_officina, b_fuori;
}officina;
